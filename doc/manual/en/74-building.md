...
Our goal in the pgexporter project is to develop an excellent software system. This requires careful attention to
...
* Don't skip becoming familiar with the part of the codebase you're working on. This will let you write better prompts
  ...
  but don't trust claims they make about how pgexporter works. LLMs are often wrong, even about details that are clearly
  answered in the pgexporter documentation and surrounding code
...
As noted above, pgexporter's contributors are expected to communicate with intention, to avoid wasting maintainer time
...
* Verify that everything you write is accurate, whether or not an LLM generated any part of it. pgexporter's maintainers
...
* Quoting an LLM answer is usually less helpful than linking to relevant primary sources, like source code,
  reference documentation, or web standards. If you do need to quote an LLM answer in a pgexporter conversation,
  put the answer in a pgexporter quote block, to distinguish LLM output from your own thoughts.
